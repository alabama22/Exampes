...
// 2. Если на текущей позиции элемент совпал с find, операцию можно завершить, 
// потому что мы нашли позицию.
// 3. Если элемент не совпал с find, увеличиваем значение счётчика index 
// на 1 и переходим на предыдущий шаг.
...
int[] array = { 11, 12, 33, 44, 25, 16, 17, 33 };
